 //set up the boat function
 //holding the fishes and their properties
 const boatInventory = () => {
    const fishes = [
 ...
 // boatHome is boatInv with fish array passed to it
 const boatHome = boatInventory()
 module.exports = {boatHome}

 //console.log(boatHome)
